    ...
    <nav class="navbar" >
        ...
        <div class="navbar-header"><!--website name/title-->
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                    ...
                    <li><a href = "achievements.php"><strong>Achievements</strong></a></li>
                    <li class="btnlogout"><a class = "btn btn-default navbar-btn" href = "index2.php"> Login/Regsiter <span class = "glyphicon glyphicon-log-in"></span></a></li>
